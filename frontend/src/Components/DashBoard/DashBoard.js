...
export default function DashBoard() {
  ...
  return (
    <div
      className={
        mode === "light" ? "main-container-light" : "main-container-dark"
      }
    >
      ...
      <div className="right-half">
        <div
          className={mode === "light" ? "slider-box-light" : "slider-box-dark"}
        >
          <Slider mode={mode} />
        </div>
        <div
          className={
            mode === "light" ? "wikipage-box-light" : "wikipage-box-dark"
          }
        >
